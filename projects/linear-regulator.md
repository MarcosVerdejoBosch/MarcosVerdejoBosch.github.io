...
<div class="case-study case-study--indexed">
...
<script>
  (() => {
    const headings = Array.from(document.querySelectorAll('.case-study__content h2[id]'));
    const links = Array.from(document.querySelectorAll('.case-study__index a'));
