...
<div class="home-wrapper">
  <div class="business-card">
    ...
    <div class="card-links">
      ...
      <a href="https://www.linkedin.com/in/marcos-verdejo-bosch-7b85b4300/" target="_blank" class="icon-link" title="LinkedIn">
        <svg class="icon" viewBox="0 0 24 24" fill="currentColor">
      ...
      <a href="#" id="email-btn" class="icon-link" onclick="copyEmail(); return false;" title="Copy Email">
        <svg class="icon" viewBox="0 0 24 24" fill="currentColor">
